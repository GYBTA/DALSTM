...
The experiment evaluate the performance of our method based on sequence features
'''
...
history=model.fit({'main_input': trainhot}, {'main_output': trainlabel}, validation_data=({'main_input': valhot},{'main_output': vallabel}),
...
score = model.evaluate({'main_input': testhot},{'main_output': test_label}, verbose=2, batch_size=2)
print score 
